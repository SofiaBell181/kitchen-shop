...
lines.forEach(line => {
  line.addEventListener('click', () => {
    ...
    const nav = document.querySelectorAll('.common');
    nav.forEach(navCommon => {
      navCommon.classList.toggle('nav-style');
    })
...
gsap.to('.common', {opacity:1, y:0, duration:3, ease: "power2.out", delay:.5});
gsap.from('.kitchen-container', {opacity:0, duration:2, delay:.5});
...
let myNav = document.querySelector('.container-fluid');
